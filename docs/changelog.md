...
| PR | Description | Date |
|----|-------------|------|
| [#171](https://github.com/sfrankle/haven-app/pull/171) | Complete a Routine screen: checklist of items with editable prescribed detail, batch entry creation on submit, unchecked items skipped, Focus auto-association, and 29 unit tests | 2026-05-24 |
