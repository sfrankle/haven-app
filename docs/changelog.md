...
| PR | Description | Date |
|----|-------------|------|
| [#108](https://github.com/sfrankle/haven-app/pull/108) | Three core logging bug fixes: navigation error when switching tabs, Trace not refreshing after logging, and within-day entry order reversed | 2026-03-27 |
