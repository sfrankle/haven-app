...
Read these files before making any UI, copy, or interaction decisions.
...
For frontend implementation guidance specific to Claude, read `.claude/design-guidance.md`.
