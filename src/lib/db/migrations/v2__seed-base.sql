...
SELECT 'Sleep', id, 'Slumber', 'How many hours did you sleep?', 'moon', 1, 1, 5 FROM measurement_type WHERE name = 'numeric'
UNION ALL
...
UNION ALL
SELECT 'Emotion', id, 'Unveil', 'How are you feeling?', 'heart', 1, 1, 3 FROM measurement_type WHERE name = 'label_select'
UNION ALL
SELECT 'Physical', id, 'Attune', 'How does your body feel?', 'child', 1, 1, 4 FROM measurement_type WHERE name = 'label_select_severity'
UNION ALL
SELECT 'Activity', id, 'Journey', 'What did you do?', 'hand-holding-heart', 1, 1, 6 FROM measurement_type WHERE name = 'label_select';
